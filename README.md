...
Main Architecture          | Attention guiding (refer to Eq. 3 in the paper)
:-------------------------:|:-------------------------:
<img src="docs/Images/2_main.jpg" width="800">  | <img src="docs/Images/attention_guiding.gif" width="200">
